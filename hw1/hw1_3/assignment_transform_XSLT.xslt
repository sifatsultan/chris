			...
			<body>
				...
				<FormatDisplayWebpage>
					...
					<xsl:for-each select="StudentsData/Students">
						...
						<p>
							Title:
							<xsl:value-of select="StudentTitle" />
						</p>
						<p>
							Surname:
						...
						<p>
							...
							<xsl:value-of select="PreferredGivenNames" />
						</p>
						<p>
							Gender:
						...
						<p>
							Student Start Date:
							<xsl:value-of select="StartDateCorr" />
						</p>

						<!-- Put a Line break after each student details -->
						<hr />
						<!--End of Tell XSLT Transformer to get the text content of the matched 
							tag "<xsl:template match="FormatDisplayWebpage" -->
					</xsl:for-each>
				</FormatDisplayWebpage>
